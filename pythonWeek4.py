...
for i in range(1, 5):
    ...
    model = sm.OLS(anscombe[f'y{i}'], design_matrix)
    ...
    print(f"Execution time for Dataset {i}: {model_execution_time:.6f} seconds\n")

# Total execution time
total_execution_time = time.time() - start_time
print(f"Total execution time for all datasets: {total_execution_time:.6f} seconds")
